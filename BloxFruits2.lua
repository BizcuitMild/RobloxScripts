...
local PresetColor = Color3.fromRGB(255, 15, 235)
...
function library:Window(name,game)
	if getgenv().Theme ~= nil then
		...
		ColorII = Color3.fromRGB(255, 15, 235)

		ColorIII = Color3.fromRGB(255, 15, 235)
		ColorIIII = Color3.fromRGB(160, 0, 255)

		ColorIIIII = Color3.fromRGB(255, 15, 235)
		ColorIIIIII = Color3.fromRGB(160, 0, 255)

		ColorIIIIIII = Color3.fromRGB(255, 15, 235)
		ColorIIIIIIII = Color3.fromRGB(160, 0, 255)
	end
	...
	Toggleui.TextColor3 = Color3.fromRGB(255, 15, 235)
	...
	TabSet.Text = ""
	TabSet.TextColor3 = Color3.fromRGB(255, 15, 235)
	TabSet.PlaceholderColor3 = Color3.fromRGB(255, 15, 235)
	...
	function Tabs:Tab(text,Real)
		...
		SectionBorder.ImageColor3 = Color3.fromRGB(255, 15, 235)
		...
		function TabElements:Button(text,callback)
			...
			Button.MouseEnter:connect(function()
				TweenService:Create(
					...
					{TextColor3 = Color3.fromRGB(255, 15, 235)}
				):Play()
			end)
		...
		function TabElements:Toggle(text,stats,callback)
			...
			local function SetState(state)
				if state then
					TweenService:Create(Title, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {TextColor3 = Color3.fromRGB(255, 15, 235)}):Play()
		...
		function TabElements:Dropdown(name, options, presetoption, callback)
			...
			if type(presetoption) == "number" then
				if presetoption <= 0 then
					...
					if options[presetoption] ~= nil then
						...
						TitleToggle.TextColor3 = Color3.fromRGB(255, 15, 235)
			...
			for i, v in pairs(options) do
				...
				NameButton.MouseButton1Down:Connect(function()
					...
					if SelectedOption ~= "nil" then
						TweenService:Create(TitleToggle, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(255, 15, 235)}):Play()
					end
					TweenService:Create(NameDropdown, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = UDim2.new(0, 475, 0, 30)}):Play()
		...
		function TabElements:Line()
			...
			Line.BackgroundColor3 = Color3.fromRGB(255, 15, 235)
			...
			Button.Name = "Button"
			Button.Parent = Line
			Button.BackgroundColor3 = Color3.fromRGB(255, 15, 235)
			Button.BackgroundTransparency = 1.000
			Button.BorderSizePixel = 0
			Button.ClipsDescendants = true
		...
		function TabElements:Label(text)
			...
			Label.TextColor3 = Color3.fromRGB(255, 15, 235)
...
local Main = library:Window("Angun","Blox Fruit Update 17 Part 2")
			...
			if DevilFruitESP then
				if string.find(v.Name, "Fruit") then   
					if not v.Handle:FindFirstChild('NameEsp'..Number) then
						...
						name.BackgroundTransparency = 1
						name.TextStrokeTransparency = 0.5
						name.TextColor3 = Color3.fromRGB(255, 15, 235)
...
MiscTab:Button("Redeem Beli Code",function()
...
MiscTab:Button("Redeem Title Code",function()
	function UseCode(Text)
		game:GetService("ReplicatedStorage").Remotes.Redeem:InvokeServer(Text)
	end
	UseCode("BigNews")
end)
MiscTab:Button("Redeem Refund Code1",function()
	function UseCode(Text)
		game:GetService("ReplicatedStorage").Remotes.Redeem:InvokeServer(Text)
	end
	UseCode("Sub2UncleKizaru")
end)
MiscTab:Button("Redeem Refund Code2",function()
	function UseCode(Text)
		game:GetService("ReplicatedStorage").Remotes.Redeem:InvokeServer(Text)
	end
	UseCode("SUB2GAMERROBOT_RESET1")
end)
MiscTab:Button("Redeem Experience Code",function()
	function UseCode(Text)
		game:GetService("ReplicatedStorage").Remotes.Redeem:InvokeServer(Text)
	end
	UseCode("Sub2Fer999")
...
FOVCircle.Color = Color3.fromRGB(255, 15, 235)
